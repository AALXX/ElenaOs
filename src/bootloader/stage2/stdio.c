...
int *printf_number(int *argp, int length_value, bool sign, int radix);
    ...
    while (*fmt)
    {
        ...
        case PRINTF_LENGTH_STATE:
            ...
            case 'h':
                ...
                state = PRINTF_LENGTH_SHORT_STATE;
                break;
            case 'l':
                length = PRINTF_LENGTH_LONG;
                state = PRINTF_LENGTH_LONG_STATE;
                break;
            default:
        ...
        case PRINTF_LENGTH_SHORT_STATE:
            if (*fmt == 'h')
            {
